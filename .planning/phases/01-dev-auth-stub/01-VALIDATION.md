...
| **Quick run command** | `flutter test test/auth/` |
...
- **After every task commit:** Run `flutter test test/auth/`
...
| 1-02-01 | 02 | 1 | DEV-AUTH-01 | — | Contratto pubblico invariato | unit | `flutter test test/auth/auth_token_service_contract_test.dart` | ❌ W0 | ⬜ pending |
| 1-02-02 | 02 | 1 | DEV-AUTH-02 | — | Legge `.env` al cold start | unit | `flutter test test/auth/dev_auth_token_service_test.dart` | ❌ W0 | ⬜ pending |
| 1-02-03 | 02 | 1 | DEV-AUTH-03 | — | `DEV_AUTH_ROLE` produce User con role | unit | `flutter test test/auth/dev_auth_token_service_role_test.dart` | ❌ W0 | ⬜ pending |
| 1-02-04 | 02 | 1 | DEV-AUTH-04 | — | `login()`/`logout()` no-op (log warning) | unit | `flutter test test/auth/dev_auth_token_service_noop_test.dart` | ❌ W0 | ⬜ pending |
...
- [ ] `test/auth/` — directory con stub test file per DEV-AUTH-01..04
